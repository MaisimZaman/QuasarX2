...
def login_view(request, *args, **kwargs):
	...
	user = request.user
	if user.is_authenticated: 
		return redirect("blog:home-home")
...
def account_view(request, *args, **kwargs):
	...
	if account:
		...
		user_posts = Post.objects.filter(author=account).order_by('-date_posted')
		user_videos = Video.objects.filter(author=account).order_by('-date_posted')
